...
"""
# RESOLVA AQUI:
url2 = "https://brasilapi.com.br/api/banks/v1"
response2 = requests.get(url2)
response2.status_code
bancos = response2.json()
...
"""
# RESOLVA AQUI:
url3 = "https://servicodados.ibge.gov.br/api/v1/localidades/aglomeracoes-urbanas/00301"
response3 = requests.get(url3)
response3.status_code
ibge = response3.json()[0]["municipios"]
df3 = pd.DataFrame(ibge)
df_uf = pd.json_normalize(df3['UF'])
